...
int handleMeasurePayload(sMobileReportPayload *pLoad, bn_Address origin){
    ...
    bn_printfDbg((char*)"%hx : (%lu,%d) (%d,%d)", origin, pLoad->value, ((int)(angle*180./M_PI))%180,(int)msg.payload.genericStatus.adv_status.pos.x,(int)msg.payload.genericStatus.adv_status.pos.y);
#endif
    return 0;
