...
static char *err_mesg[] = { "unknown error", /* 0 */
...
static char *warn_mesg[] = { "unknown warning", /* 0 */
...
static Err_list err_list[ERR_LIST_MAX_LEN] = { { err_mesg, MAXERR, FALSE }, /* basic errors list */
