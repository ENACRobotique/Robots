...
ZMAT *zsm_mlt(scalar, matrix, out)
    complex scalar;ZMAT *matrix, *out; {
    unsigned int m, n, i;
...
ZVEC *zmv_mltadd(v1, v2, A, alpha, out)
    ZVEC *v1, *v2, *out;ZMAT *A;complex alpha; {
    /* register	int	j; */
    int i, m, n;
