...
VEC *pccg(A, A_params, M_inv, M_params, b, eps, x)
    MTX_FN A, M_inv;VEC *b, *x;double eps;void *A_params, *M_params; {
...
VEC *sp_pccg(A, LLT, b, eps, x)
    SPMAT *A, *LLT;VEC *b, *x;double eps; {
...
VEC *cgs(A, A_params, b, r0, tol, x)
    MTX_FN A;VEC *x, *b;VEC *r0; /* tilde r0 parameter -- should be random??? */
...
VEC *lsqr(A, AT, A_params, b, tol, x)
    ...
    VEC *x, *b;double tol; /* error tolerance used */
    void *A_params; {
    VEC *u, *v, *w, *tmp;
