...
/*!
  ...
  */
int serialib::ReadChar(unsigned char *pByte,unsigned int TimeOut_ms)
{
...
/*!
  ...
  */
int serialib::ReadStringNoTimeOut(unsigned char *String,char FinalChar,unsigned int MaxNbBytes)
{
...
/*!
     ...
     \return -3 MaxNbBytes is reached
  */
int serialib::ReadString(unsigned char *String,char FinalChar,unsigned int MaxNbBytes,unsigned int TimeOut_ms)
{
    if (TimeOut_ms==0)
