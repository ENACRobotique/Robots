...
void a_star(iABObs_t _start, iABObs_t _goal, sPath_t *path){
    ...
    sSeg_t *seg;
    sASNode_t os_start /* openset start */, start = {.o1 = _start, .o2 = _start}, goal = {.o1 = _goal, .o2 = _goal}, neighbor, current, prev, curr, next;
#ifdef AS_STATS
...
printf("  found solution (reverse order):\n");
            ...
            for (path->path_len = 1, curr = current; curr.o1 != start.o1 && curr.o2 != start.o2; path->path_len++, curr = ASELT(curr).prev); // oh putaing !
