...
std::vector<astar::sObs_t> obs= {
   ...
   //Starting zone
   {{39., 79.}, 2. + R_ROBOT, 0, 1, 1}, //34
   {{15., 79.}, 2. + R_ROBOT, 0, 1, 1},
   {{39.,121.}, 2. + R_ROBOT, 0, 1, 1},
   {{15.,121.}, 2. + R_ROBOT, 0, 1, 1},
   {{300 - 39., 79.}, 2. + R_ROBOT, 0, 1, 1},
   {{300 - 15., 79.}, 2. + R_ROBOT, 0, 1, 1},
   {{300 - 39.,121.}, 2. + R_ROBOT, 0, 1, 1},
   {{300 - 15.,121.}, 2. + R_ROBOT, 0, 1, 1},
