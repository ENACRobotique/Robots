...
typedef struct{
    eObj_t  etype;                          //type d'objectif
    eStateObj_t state;                      //used or not
    ...
    sObjPt_t  entryPoint[MAX_EP_BY_OBJ];    //liste des point d'accès pour atteindre l'objectif
    uTypeObj utype;
    } sObj_t;
