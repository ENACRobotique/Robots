...
sObs_t obs[] = {
    ...
    {{0., 0.}, R_ROBOT+20., 1, 1},   //primary adv
    {{0., 0.}, R_ROBOT+15., 1, 1},   //secondary adv

    // arbres
    {{0.  , 70. }, R_ROBOT+10, 0, 1}, // 1
    {{70. , 0.  }, R_ROBOT+10, 0, 1},
    {{230., 0.  }, R_ROBOT+10, 0, 1},
    {{300., 70. }, R_ROBOT+10, 0, 1},

    // bac fruit
    {{75. , 185.}, R_ROBOT+15,0, 1},//5
    {{42. , 185.}, R_ROBOT+5, 0, 1},
    {{108. ,185.}, R_ROBOT+5, 0, 1},
    {{42. , 172.}, R_ROBOT+5, 0, 1},
    {{108., 172.}, R_ROBOT+5, 0, 1},

    {{225., 185.}, R_ROBOT+15,0, 1},//10
    {{192., 185.}, R_ROBOT+5, 0, 1},
    {{258., 185.}, R_ROBOT+5, 0, 1},
    {{192., 172.}, R_ROBOT+5, 0, 1},
    {{258., 172.}, R_ROBOT+5, 0, 1},

    // foyers
    {{0.  , 0.  }, R_ROBOT+27, 0, 1}, // 15
    {{300., 0.  }, R_ROBOT+27, 0, 1},
    {{150., 95. }, R_ROBOT+18, 0, 1},

    // torches mobile
    {{90. , 90. }, R_ROBOT+9, 1, 1}, // 18
    {{210., 90. }, R_ROBOT+9, 1, 1},

    // torches fixe
    {{1.1  , 125.8}, R_ROBOT+1, 0, 1}, // 20
    {{1.1  , 114.2}, R_ROBOT+1, 0, 1},
    {{135.8, 1.1  }, R_ROBOT+1, 0, 1},
    {{124.2, 1.1  }, R_ROBOT+1, 0, 1},
    {{175.8, 1.1  }, R_ROBOT+1, 0, 1},
    {{164.2, 1.1  }, R_ROBOT+1, 0, 1},
    {{298.9, 125.8}, R_ROBOT+1, 0, 1},
    {{298.9, 114.2}, R_ROBOT+1, 0, 1},

    // feux
    {{40. , 90. }, R_ROBOT+3, 1, 1},//28
    {{90. , 40. }, R_ROBOT+7, 1, 1},
    {{90. , 140.}, R_ROBOT+7, 1, 1},//30
    {{210., 40. }, R_ROBOT+7, 1, 1},
    {{210., 140.}, R_ROBOT+7, 1, 1},
    {{260., 90. }, R_ROBOT+3, 1, 1},
