...
unsigned int _raw2dist[] = {    // sizeof(unsigned int)==2 => 65535 max
//  _raw2dist[raw>>3] is in centimers<<4 when raw is from 0 to 1023
...
int raw2dist(int m) {    // returns centimeters<<4
    // m is from 0 to 1023
